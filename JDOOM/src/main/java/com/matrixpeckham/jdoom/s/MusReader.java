...
public class MusReader {
    ...
    public static Sequence getSequence(InputStream is)
        ...
        short scoreStart = SHORT((char) rus);
    ...
    private static EventGroup
            nextEventGroup(InputStream is, int[] channelVelocity) throws
            IOException {
        ...
        do {
            ...
            switch (eventType) {
                ...
                case 4:
                    ...
                    if ((cVal & 0x80) != 0) {
                        String msg = String.format(
                                "Invalid controller value (%d; cNum=%d)", cVal,
                                cNum);
                        throw new IllegalArgumentException(msg);
                    }
                    switch (cNum) {
                        ...
                        default:
                            throw new AssertionError(
                                    "Unknown controller number: " + cNum
                                    + "(value: " + cVal + ")");
                    }
                    break;
                case 6:
                    return result.emptyToNull();
                default:
                    String msg = String.format("Unknown event type: %d",
                            eventType);
                    throw new IllegalArgumentException(msg);
            }
        } while (!last);
    ...
    private static class EventGroup {
        ...
        void pitchBend(int midiChan, int wheelVal) {
            ...
            addShortMessage(midiChan, ShortMessage.PITCH_BEND, pb14 % 128, pb14
                    / 128);
        }
        ...
        private void addControlChange(int midiChan, int ctrlId, int ctrlVal) {
            addShortMessage(midiChan, ShortMessage.CONTROL_CHANGE, ctrlId,
                    ctrlVal);
        }
