...
import static com.matrixpeckham.jdoom.info.SpriteNum.*;
import static com.matrixpeckham.jdoom.info.StateNum.*;
...
public class Info {
    ...
    private static final Procedure A_Light0 = null,
            A_WeaponReady = null,
            A_Lower = null,
            A_Raise = null,
            A_Punch = null,
    ...
    public static final State[] states = {
        ...
        new State(SPR_SHTG, 4, 0, A_Light0, S_NULL, 0, 0), // S_LIGHTDONE
        new State(SPR_PUNG, 0, 1, A_WeaponReady, S_PUNCH, 0, 0), // S_PUNCH
        new State(SPR_PUNG, 0, 1, A_Lower, S_PUNCHDOWN, 0, 0), // S_PUNCHDOWN
        new State(SPR_PUNG, 0, 1, A_Raise, S_PUNCHUP, 0, 0), // S_PUNCHUP
        new State(SPR_PUNG, 1, 4, null, S_PUNCH2, 0, 0), // S_PUNCH1
        new State(SPR_PUNG, 2, 4, A_Punch, S_PUNCH3, 0, 0), // S_PUNCH2
        new State(SPR_PUNG, 3, 5, null, S_PUNCH4, 0, 0), // S_PUNCH3
        new State(SPR_PUNG, 2, 4, null, S_PUNCH5, 0, 0), // S_PUNCH4
        new State(SPR_PUNG, 1, 5, A_ReFire, S_PUNCH, 0, 0), // S_PUNCH5
        new State(SPR_PISG, 0, 1, A_WeaponReady, S_PISTOL, 0, 0), // S_PISTOL
        new State(SPR_PISG, 0, 1, A_Lower, S_PISTOLDOWN, 0, 0), // S_PISTOLDOWN
        new State(SPR_PISG, 0, 1, A_Raise, S_PISTOLUP, 0, 0), // S_PISTOLUP
        new State(SPR_PISG, 0, 4, null, S_PISTOL2, 0, 0), // S_PISTOL1
        new State(SPR_PISG, 1, 6, A_FirePistol, S_PISTOL3, 0, 0),// S_PISTOL2
        new State(SPR_PISG, 2, 4, null, S_PISTOL4, 0, 0), // S_PISTOL3
        new State(SPR_PISG, 1, 5, A_ReFire, S_PISTOL, 0, 0), // S_PISTOL4
        new State(SPR_PISF, 32768, 7, A_Light1, S_LIGHTDONE, 0, 0), // S_PISTOLFLASH
        new State(SPR_SHTG, 0, 1, A_WeaponReady, S_SGUN, 0, 0), // S_SGUN
        new State(SPR_SHTG, 0, 1, A_Lower, S_SGUNDOWN, 0, 0), // S_SGUNDOWN
        new State(SPR_SHTG, 0, 1, A_Raise, S_SGUNUP, 0, 0), // S_SGUNUP
        new State(SPR_SHTG, 0, 3, null, S_SGUN2, 0, 0), // S_SGUN1
        new State(SPR_SHTG, 0, 7, A_FireShotgun, S_SGUN3, 0, 0), // S_SGUN2
        ...
        new State(SPR_SHTG, 0, 7, A_ReFire, S_SGUN, 0, 0), // S_SGUN9
        new State(SPR_SHTF, 32768, 4, A_Light1, S_SGUNFLASH2, 0, 0), // S_SGUNFLASH1
        new State(SPR_SHTF, 32769, 3, A_Light2, S_LIGHTDONE, 0, 0), // S_SGUNFLASH2
        new State(SPR_SHT2, 0, 1, A_WeaponReady, S_DSGUN, 0, 0), // S_DSGUN
        new State(SPR_SHT2, 0, 1, A_Lower, S_DSGUNDOWN, 0, 0), // S_DSGUNDOWN
        new State(SPR_SHT2, 0, 1, A_Raise, S_DSGUNUP, 0, 0), // S_DSGUNUP
        new State(SPR_SHT2, 0, 3, null, S_DSGUN2, 0, 0), // S_DSGUN1
        new State(SPR_SHT2, 0, 7, A_FireShotgun2, S_DSGUN3, 0, 0), // S_DSGUN2
        new State(SPR_SHT2, 1, 7, null, S_DSGUN4, 0, 0), // S_DSGUN3
        new State(SPR_SHT2, 2, 7, A_CheckReload, S_DSGUN5, 0, 0), // S_DSGUN4
        new State(SPR_SHT2, 3, 7, A_OpenShotgun2, S_DSGUN6, 0, 0), // S_DSGUN5
        new State(SPR_SHT2, 4, 7, null, S_DSGUN7, 0, 0), // S_DSGUN6
        new State(SPR_SHT2, 5, 7, A_LoadShotgun2, S_DSGUN8, 0, 0), // S_DSGUN7
        new State(SPR_SHT2, 6, 6, null, S_DSGUN9, 0, 0), // S_DSGUN8
        new State(SPR_SHT2, 7, 6, A_CloseShotgun2, S_DSGUN10, 0, 0), // S_DSGUN9
        new State(SPR_SHT2, 0, 5, A_ReFire, S_DSGUN, 0, 0), // S_DSGUN10
        new State(SPR_SHT2, 1, 7, null, S_DSNR2, 0, 0), // S_DSNR1
        new State(SPR_SHT2, 0, 3, null, S_DSGUNDOWN, 0, 0), // S_DSNR2
        new State(SPR_SHT2, 32776, 5, A_Light1, S_DSGUNFLASH2, 0, 0), // S_DSGUNFLASH1
        new State(SPR_SHT2, 32777, 4, A_Light2, S_LIGHTDONE, 0, 0), // S_DSGUNFLASH2
        new State(SPR_CHGG, 0, 1, A_WeaponReady, S_CHAIN, 0, 0), // S_CHAIN
        new State(SPR_CHGG, 0, 1, A_Lower, S_CHAINDOWN, 0, 0), // S_CHAINDOWN
        new State(SPR_CHGG, 0, 1, A_Raise, S_CHAINUP, 0, 0), // S_CHAINUP
        new State(SPR_CHGG, 0, 4, A_FireCGun, S_CHAIN2, 0, 0), // S_CHAIN1
        new State(SPR_CHGG, 1, 4, A_FireCGun, S_CHAIN3, 0, 0), // S_CHAIN2
        new State(SPR_CHGG, 1, 0, A_ReFire, S_CHAIN, 0, 0), // S_CHAIN3
        new State(SPR_CHGF, 32768, 5, A_Light1, S_LIGHTDONE, 0, 0), // S_CHAINFLASH1
        new State(SPR_CHGF, 32769, 5, A_Light2, S_LIGHTDONE, 0, 0), // S_CHAINFLASH2
        new State(SPR_MISG, 0, 1, A_WeaponReady, S_MISSILE, 0, 0), // S_MISSILE
        new State(SPR_MISG, 0, 1, A_Lower, S_MISSILEDOWN, 0, 0), // S_MISSILEDOWN
        new State(SPR_MISG, 0, 1, A_Raise, S_MISSILEUP, 0, 0), // S_MISSILEUP
        new State(SPR_MISG, 1, 8, A_GunFlash, S_MISSILE2, 0, 0), // S_MISSILE1
        new State(SPR_MISG, 1, 12, A_FireMissile, S_MISSILE3, 0, 0), // S_MISSILE2
        new State(SPR_MISG, 1, 0, A_ReFire, S_MISSILE, 0, 0), // S_MISSILE3
        new State(SPR_MISF, 32768, 3, A_Light1, S_MISSILEFLASH2, 0, 0), // S_MISSILEFLASH1
        new State(SPR_MISF, 32769, 4, null, S_MISSILEFLASH3, 0, 0), // S_MISSILEFLASH2
        new State(SPR_MISF, 32770, 4, A_Light2, S_MISSILEFLASH4, 0, 0), // S_MISSILEFLASH3
        new State(SPR_MISF, 32771, 4, A_Light2, S_LIGHTDONE, 0, 0), // S_MISSILEFLASH4
        new State(SPR_SAWG, 2, 4, A_WeaponReady, S_SAWB, 0, 0), // S_SAW
        new State(SPR_SAWG, 3, 4, A_WeaponReady, S_SAW, 0, 0), // S_SAWB
        new State(SPR_SAWG, 2, 1, A_Lower, S_SAWDOWN, 0, 0), // S_SAWDOWN
        new State(SPR_SAWG, 2, 1, A_Raise, S_SAWUP, 0, 0), // S_SAWUP
        new State(SPR_SAWG, 0, 4, A_Saw, S_SAW2, 0, 0), // S_SAW1
        new State(SPR_SAWG, 1, 4, A_Saw, S_SAW3, 0, 0), // S_SAW2
        new State(SPR_SAWG, 1, 0, A_ReFire, S_SAW, 0, 0), // S_SAW3
        new State(SPR_PLSG, 0, 1, A_WeaponReady, S_PLASMA, 0, 0), // S_PLASMA
        new State(SPR_PLSG, 0, 1, A_Lower, S_PLASMADOWN, 0, 0), // S_PLASMADOWN
        new State(SPR_PLSG, 0, 1, A_Raise, S_PLASMAUP, 0, 0), // S_PLASMAUP
        new State(SPR_PLSG, 0, 3, A_FirePlasma, S_PLASMA2, 0, 0), // S_PLASMA1
        new State(SPR_PLSG, 1, 20, A_ReFire, S_PLASMA, 0, 0), // S_PLASMA2
        new State(SPR_PLSF, 32768, 4, A_Light1, S_LIGHTDONE, 0, 0), // S_PLASMAFLASH1
        new State(SPR_PLSF, 32769, 4, A_Light1, S_LIGHTDONE, 0, 0), // S_PLASMAFLASH2
        new State(SPR_BFGG, 0, 1, A_WeaponReady, S_BFG, 0, 0), // S_BFG
        new State(SPR_BFGG, 0, 1, A_Lower, S_BFGDOWN, 0, 0), // S_BFGDOWN
        new State(SPR_BFGG, 0, 1, A_Raise, S_BFGUP, 0, 0), // S_BFGUP
        new State(SPR_BFGG, 0, 20, A_BFGsound, S_BFG2, 0, 0), // S_BFG1
        new State(SPR_BFGG, 1, 10, A_GunFlash, S_BFG3, 0, 0), // S_BFG2
        new State(SPR_BFGG, 1, 10, A_FireBFG, S_BFG4, 0, 0), // S_BFG3
        new State(SPR_BFGG, 1, 20, A_ReFire, S_BFG, 0, 0), // S_BFG4
        new State(SPR_BFGF, 32768, 11, A_Light1, S_BFGFLASH2, 0, 0), // S_BFGFLASH1
        new State(SPR_BFGF, 32769, 6, A_Light2, S_LIGHTDONE, 0, 0), // S_BFGFLASH2
        ...
        new State(SPR_BFE1, 32770, 8, A_BFGSpray, S_BFGLAND4, 0, 0), // S_BFGLAND3
        ...
        new State(SPR_MISL, 32769, 8, A_Explode, S_EXPLODE2, 0, 0), // S_EXPLODE1
        ...
        new State(SPR_PLAY, 6, 4, A_Pain, S_PLAY, 0, 0), // S_PLAY_PAIN2
        new State(SPR_PLAY, 7, 10, null, S_PLAY_DIE2, 0, 0), // S_PLAY_DIE1
        new State(SPR_PLAY, 8, 10, A_PlayerScream, S_PLAY_DIE3, 0, 0), // S_PLAY_DIE2
        new State(SPR_PLAY, 9, 10, A_Fall, S_PLAY_DIE4, 0, 0), // S_PLAY_DIE3
        ...
        new State(SPR_PLAY, 15, 5, A_XScream, S_PLAY_XDIE3, 0, 0), // S_PLAY_XDIE2
        new State(SPR_PLAY, 16, 5, A_Fall, S_PLAY_XDIE4, 0, 0), // S_PLAY_XDIE3
        ...
        new State(SPR_POSS, 0, 10, A_Look, S_POSS_STND2, 0, 0), // S_POSS_STND
        new State(SPR_POSS, 1, 10, A_Look, S_POSS_STND, 0, 0), // S_POSS_STND2
        new State(SPR_POSS, 0, 4, A_Chase, S_POSS_RUN2, 0, 0), // S_POSS_RUN1
        new State(SPR_POSS, 0, 4, A_Chase, S_POSS_RUN3, 0, 0), // S_POSS_RUN2
        new State(SPR_POSS, 1, 4, A_Chase, S_POSS_RUN4, 0, 0), // S_POSS_RUN3
        new State(SPR_POSS, 1, 4, A_Chase, S_POSS_RUN5, 0, 0), // S_POSS_RUN4
        new State(SPR_POSS, 2, 4, A_Chase, S_POSS_RUN6, 0, 0), // S_POSS_RUN5
        new State(SPR_POSS, 2, 4, A_Chase, S_POSS_RUN7, 0, 0), // S_POSS_RUN6
        new State(SPR_POSS, 3, 4, A_Chase, S_POSS_RUN8, 0, 0), // S_POSS_RUN7
        new State(SPR_POSS, 3, 4, A_Chase, S_POSS_RUN1, 0, 0), // S_POSS_RUN8
        new State(SPR_POSS, 4, 10, A_FaceTarget, S_POSS_ATK2, 0, 0), // S_POSS_ATK1
        new State(SPR_POSS, 5, 8, A_PosAttack, S_POSS_ATK3, 0, 0), // S_POSS_ATK2
        new State(SPR_POSS, 4, 8, null, S_POSS_RUN1, 0, 0), // S_POSS_ATK3
        new State(SPR_POSS, 6, 3, null, S_POSS_PAIN2, 0, 0), // S_POSS_PAIN
        new State(SPR_POSS, 6, 3, A_Pain, S_POSS_RUN1, 0, 0), // S_POSS_PAIN2
        new State(SPR_POSS, 7, 5, null, S_POSS_DIE2, 0, 0), // S_POSS_DIE1
        new State(SPR_POSS, 8, 5, A_Scream, S_POSS_DIE3, 0, 0), // S_POSS_DIE2
        new State(SPR_POSS, 9, 5, A_Fall, S_POSS_DIE4, 0, 0), // S_POSS_DIE3
        ...
        new State(SPR_POSS, 13, 5, A_XScream, S_POSS_XDIE3, 0, 0), // S_POSS_XDIE2
        new State(SPR_POSS, 14, 5, A_Fall, S_POSS_XDIE4, 0, 0), // S_POSS_XDIE3
        ...
        new State(SPR_SPOS, 0, 10, A_Look, S_SPOS_STND2, 0, 0), // S_SPOS_STND
        new State(SPR_SPOS, 1, 10, A_Look, S_SPOS_STND, 0, 0), // S_SPOS_STND2
        new State(SPR_SPOS, 0, 3, A_Chase, S_SPOS_RUN2, 0, 0), // S_SPOS_RUN1
        new State(SPR_SPOS, 0, 3, A_Chase, S_SPOS_RUN3, 0, 0), // S_SPOS_RUN2
        new State(SPR_SPOS, 1, 3, A_Chase, S_SPOS_RUN4, 0, 0), // S_SPOS_RUN3
        new State(SPR_SPOS, 1, 3, A_Chase, S_SPOS_RUN5, 0, 0), // S_SPOS_RUN4
        new State(SPR_SPOS, 2, 3, A_Chase, S_SPOS_RUN6, 0, 0), // S_SPOS_RUN5
        new State(SPR_SPOS, 2, 3, A_Chase, S_SPOS_RUN7, 0, 0), // S_SPOS_RUN6
        new State(SPR_SPOS, 3, 3, A_Chase, S_SPOS_RUN8, 0, 0), // S_SPOS_RUN7
        new State(SPR_SPOS, 3, 3, A_Chase, S_SPOS_RUN1, 0, 0), // S_SPOS_RUN8
        new State(SPR_SPOS, 4, 10, A_FaceTarget, S_SPOS_ATK2, 0, 0), // S_SPOS_ATK1
        new State(SPR_SPOS, 32773, 10, A_SPosAttack, S_SPOS_ATK3, 0, 0), // S_SPOS_ATK2
        new State(SPR_SPOS, 4, 10, null, S_SPOS_RUN1, 0, 0), // S_SPOS_ATK3
        new State(SPR_SPOS, 6, 3, null, S_SPOS_PAIN2, 0, 0), // S_SPOS_PAIN
        new State(SPR_SPOS, 6, 3, A_Pain, S_SPOS_RUN1, 0, 0), // S_SPOS_PAIN2
        new State(SPR_SPOS, 7, 5, null, S_SPOS_DIE2, 0, 0), // S_SPOS_DIE1
        new State(SPR_SPOS, 8, 5, A_Scream, S_SPOS_DIE3, 0, 0), // S_SPOS_DIE2
        new State(SPR_SPOS, 9, 5, A_Fall, S_SPOS_DIE4, 0, 0), // S_SPOS_DIE3
        ...
        new State(SPR_SPOS, 13, 5, A_XScream, S_SPOS_XDIE3, 0, 0), // S_SPOS_XDIE2
        new State(SPR_SPOS, 14, 5, A_Fall, S_SPOS_XDIE4, 0, 0), // S_SPOS_XDIE3
        ...
        new State(SPR_VILE, 0, 10, A_Look, S_VILE_STND2, 0, 0), // S_VILE_STND
        new State(SPR_VILE, 1, 10, A_Look, S_VILE_STND, 0, 0), // S_VILE_STND2
        new State(SPR_VILE, 0, 2, A_VileChase, S_VILE_RUN2, 0, 0), // S_VILE_RUN1
        new State(SPR_VILE, 0, 2, A_VileChase, S_VILE_RUN3, 0, 0), // S_VILE_RUN2
        new State(SPR_VILE, 1, 2, A_VileChase, S_VILE_RUN4, 0, 0), // S_VILE_RUN3
        new State(SPR_VILE, 1, 2, A_VileChase, S_VILE_RUN5, 0, 0), // S_VILE_RUN4
        new State(SPR_VILE, 2, 2, A_VileChase, S_VILE_RUN6, 0, 0), // S_VILE_RUN5
        new State(SPR_VILE, 2, 2, A_VileChase, S_VILE_RUN7, 0, 0), // S_VILE_RUN6
        new State(SPR_VILE, 3, 2, A_VileChase, S_VILE_RUN8, 0, 0), // S_VILE_RUN7
        new State(SPR_VILE, 3, 2, A_VileChase, S_VILE_RUN9, 0, 0), // S_VILE_RUN8
        new State(SPR_VILE, 4, 2, A_VileChase, S_VILE_RUN10, 0, 0), // S_VILE_RUN9
        new State(SPR_VILE, 4, 2, A_VileChase, S_VILE_RUN11, 0, 0), // S_VILE_RUN10
        new State(SPR_VILE, 5, 2, A_VileChase, S_VILE_RUN12, 0, 0), // S_VILE_RUN11
        new State(SPR_VILE, 5, 2, A_VileChase, S_VILE_RUN1, 0, 0), // S_VILE_RUN12
        new State(SPR_VILE, 32774, 0, A_VileStart, S_VILE_ATK2, 0, 0), // S_VILE_ATK1
        new State(SPR_VILE, 32774, 10, A_FaceTarget, S_VILE_ATK3, 0, 0), // S_VILE_ATK2
        new State(SPR_VILE, 32775, 8, A_VileTarget, S_VILE_ATK4, 0, 0), // S_VILE_ATK3
        new State(SPR_VILE, 32776, 8, A_FaceTarget, S_VILE_ATK5, 0, 0), // S_VILE_ATK4
        new State(SPR_VILE, 32777, 8, A_FaceTarget, S_VILE_ATK6, 0, 0), // S_VILE_ATK5
        new State(SPR_VILE, 32778, 8, A_FaceTarget, S_VILE_ATK7, 0, 0), // S_VILE_ATK6
        new State(SPR_VILE, 32779, 8, A_FaceTarget, S_VILE_ATK8, 0, 0), // S_VILE_ATK7
        new State(SPR_VILE, 32780, 8, A_FaceTarget, S_VILE_ATK9, 0, 0), // S_VILE_ATK8
        new State(SPR_VILE, 32781, 8, A_FaceTarget, S_VILE_ATK10, 0, 0), // S_VILE_ATK9
        new State(SPR_VILE, 32782, 8, A_VileAttack, S_VILE_ATK11, 0, 0), // S_VILE_ATK10
        ...
        new State(SPR_VILE, 16, 5, A_Pain, S_VILE_RUN1, 0, 0), // S_VILE_PAIN2
        new State(SPR_VILE, 16, 7, null, S_VILE_DIE2, 0, 0), // S_VILE_DIE1
        new State(SPR_VILE, 17, 7, A_Scream, S_VILE_DIE3, 0, 0), // S_VILE_DIE2
        new State(SPR_VILE, 18, 7, A_Fall, S_VILE_DIE4, 0, 0), // S_VILE_DIE3
        ...
        new State(SPR_FIRE, 32768, 2, A_StartFire, S_FIRE2, 0, 0), // S_FIRE1
        new State(SPR_FIRE, 32769, 2, A_Fire, S_FIRE3, 0, 0), // S_FIRE2
        new State(SPR_FIRE, 32768, 2, A_Fire, S_FIRE4, 0, 0), // S_FIRE3
        new State(SPR_FIRE, 32769, 2, A_Fire, S_FIRE5, 0, 0), // S_FIRE4
        new State(SPR_FIRE, 32770, 2, A_FireCrackle, S_FIRE6, 0, 0), // S_FIRE5
        new State(SPR_FIRE, 32769, 2, A_Fire, S_FIRE7, 0, 0), // S_FIRE6
        new State(SPR_FIRE, 32770, 2, A_Fire, S_FIRE8, 0, 0), // S_FIRE7
        new State(SPR_FIRE, 32769, 2, A_Fire, S_FIRE9, 0, 0), // S_FIRE8
        new State(SPR_FIRE, 32770, 2, A_Fire, S_FIRE10, 0, 0), // S_FIRE9
        new State(SPR_FIRE, 32771, 2, A_Fire, S_FIRE11, 0, 0), // S_FIRE10
        new State(SPR_FIRE, 32770, 2, A_Fire, S_FIRE12, 0, 0), // S_FIRE11
        new State(SPR_FIRE, 32771, 2, A_Fire, S_FIRE13, 0, 0), // S_FIRE12
        new State(SPR_FIRE, 32770, 2, A_Fire, S_FIRE14, 0, 0), // S_FIRE13
        new State(SPR_FIRE, 32771, 2, A_Fire, S_FIRE15, 0, 0), // S_FIRE14
        new State(SPR_FIRE, 32772, 2, A_Fire, S_FIRE16, 0, 0), // S_FIRE15
        new State(SPR_FIRE, 32771, 2, A_Fire, S_FIRE17, 0, 0), // S_FIRE16
        new State(SPR_FIRE, 32772, 2, A_Fire, S_FIRE18, 0, 0), // S_FIRE17
        new State(SPR_FIRE, 32771, 2, A_Fire, S_FIRE19, 0, 0), // S_FIRE18
        new State(SPR_FIRE, 32772, 2, A_FireCrackle, S_FIRE20, 0, 0), // S_FIRE19
        new State(SPR_FIRE, 32773, 2, A_Fire, S_FIRE21, 0, 0), // S_FIRE20
        new State(SPR_FIRE, 32772, 2, A_Fire, S_FIRE22, 0, 0), // S_FIRE21
        new State(SPR_FIRE, 32773, 2, A_Fire, S_FIRE23, 0, 0), // S_FIRE22
        new State(SPR_FIRE, 32772, 2, A_Fire, S_FIRE24, 0, 0), // S_FIRE23
        new State(SPR_FIRE, 32773, 2, A_Fire, S_FIRE25, 0, 0), // S_FIRE24
        new State(SPR_FIRE, 32774, 2, A_Fire, S_FIRE26, 0, 0), // S_FIRE25
        new State(SPR_FIRE, 32775, 2, A_Fire, S_FIRE27, 0, 0), // S_FIRE26
        new State(SPR_FIRE, 32774, 2, A_Fire, S_FIRE28, 0, 0), // S_FIRE27
        new State(SPR_FIRE, 32775, 2, A_Fire, S_FIRE29, 0, 0), // S_FIRE28
        new State(SPR_FIRE, 32774, 2, A_Fire, S_FIRE30, 0, 0), // S_FIRE29
        new State(SPR_FIRE, 32775, 2, A_Fire, S_NULL, 0, 0), // S_FIRE30
        ...
        new State(SPR_FATB, 32768, 2, A_Tracer, S_TRACER2, 0, 0), // S_TRACER
        new State(SPR_FATB, 32769, 2, A_Tracer, S_TRACER, 0, 0), // S_TRACER2
        ...
        new State(SPR_SKEL, 0, 10, A_Look, S_SKEL_STND2, 0, 0), // S_SKEL_STND
        new State(SPR_SKEL, 1, 10, A_Look, S_SKEL_STND, 0, 0), // S_SKEL_STND2
        new State(SPR_SKEL, 0, 2, A_Chase, S_SKEL_RUN2, 0, 0), // S_SKEL_RUN1
        new State(SPR_SKEL, 0, 2, A_Chase, S_SKEL_RUN3, 0, 0), // S_SKEL_RUN2
        new State(SPR_SKEL, 1, 2, A_Chase, S_SKEL_RUN4, 0, 0), // S_SKEL_RUN3
        new State(SPR_SKEL, 1, 2, A_Chase, S_SKEL_RUN5, 0, 0), // S_SKEL_RUN4
        new State(SPR_SKEL, 2, 2, A_Chase, S_SKEL_RUN6, 0, 0), // S_SKEL_RUN5
        new State(SPR_SKEL, 2, 2, A_Chase, S_SKEL_RUN7, 0, 0), // S_SKEL_RUN6
        new State(SPR_SKEL, 3, 2, A_Chase, S_SKEL_RUN8, 0, 0), // S_SKEL_RUN7
        new State(SPR_SKEL, 3, 2, A_Chase, S_SKEL_RUN9, 0, 0), // S_SKEL_RUN8
        new State(SPR_SKEL, 4, 2, A_Chase, S_SKEL_RUN10, 0, 0), // S_SKEL_RUN9
        new State(SPR_SKEL, 4, 2, A_Chase, S_SKEL_RUN11, 0, 0), // S_SKEL_RUN10
        new State(SPR_SKEL, 5, 2, A_Chase, S_SKEL_RUN12, 0, 0), // S_SKEL_RUN11
        new State(SPR_SKEL, 5, 2, A_Chase, S_SKEL_RUN1, 0, 0), // S_SKEL_RUN12
        new State(SPR_SKEL, 6, 0, A_FaceTarget, S_SKEL_FIST2, 0, 0), // S_SKEL_FIST1
        new State(SPR_SKEL, 6, 6, A_SkelWhoosh, S_SKEL_FIST3, 0, 0), // S_SKEL_FIST2
        new State(SPR_SKEL, 7, 6, A_FaceTarget, S_SKEL_FIST4, 0, 0), // S_SKEL_FIST3
        new State(SPR_SKEL, 8, 6, A_SkelFist, S_SKEL_RUN1, 0, 0), // S_SKEL_FIST4
        new State(SPR_SKEL, 32777, 0, A_FaceTarget, S_SKEL_MISS2, 0, 0), // S_SKEL_MISS1
        new State(SPR_SKEL, 32777, 10, A_FaceTarget, S_SKEL_MISS3, 0, 0), // S_SKEL_MISS2
        new State(SPR_SKEL, 10, 10, A_SkelMissile, S_SKEL_MISS4, 0, 0), // S_SKEL_MISS3
        new State(SPR_SKEL, 10, 10, A_FaceTarget, S_SKEL_RUN1, 0, 0), // S_SKEL_MISS4
        new State(SPR_SKEL, 11, 5, null, S_SKEL_PAIN2, 0, 0), // S_SKEL_PAIN
        new State(SPR_SKEL, 11, 5, A_Pain, S_SKEL_RUN1, 0, 0), // S_SKEL_PAIN2
        new State(SPR_SKEL, 11, 7, null, S_SKEL_DIE2, 0, 0), // S_SKEL_DIE1
        new State(SPR_SKEL, 12, 7, null, S_SKEL_DIE3, 0, 0), // S_SKEL_DIE2
        new State(SPR_SKEL, 13, 7, A_Scream, S_SKEL_DIE4, 0, 0), // S_SKEL_DIE3
        new State(SPR_SKEL, 14, 7, A_Fall, S_SKEL_DIE5, 0, 0), // S_SKEL_DIE4
        ...
        new State(SPR_FATT, 0, 15, A_Look, S_FATT_STND2, 0, 0), // S_FATT_STND
        new State(SPR_FATT, 1, 15, A_Look, S_FATT_STND, 0, 0), // S_FATT_STND2
        new State(SPR_FATT, 0, 4, A_Chase, S_FATT_RUN2, 0, 0), // S_FATT_RUN1
        new State(SPR_FATT, 0, 4, A_Chase, S_FATT_RUN3, 0, 0), // S_FATT_RUN2
        new State(SPR_FATT, 1, 4, A_Chase, S_FATT_RUN4, 0, 0), // S_FATT_RUN3
        new State(SPR_FATT, 1, 4, A_Chase, S_FATT_RUN5, 0, 0), // S_FATT_RUN4
        new State(SPR_FATT, 2, 4, A_Chase, S_FATT_RUN6, 0, 0), // S_FATT_RUN5
        new State(SPR_FATT, 2, 4, A_Chase, S_FATT_RUN7, 0, 0), // S_FATT_RUN6
        new State(SPR_FATT, 3, 4, A_Chase, S_FATT_RUN8, 0, 0), // S_FATT_RUN7
        new State(SPR_FATT, 3, 4, A_Chase, S_FATT_RUN9, 0, 0), // S_FATT_RUN8
        new State(SPR_FATT, 4, 4, A_Chase, S_FATT_RUN10, 0, 0), // S_FATT_RUN9
        new State(SPR_FATT, 4, 4, A_Chase, S_FATT_RUN11, 0, 0), // S_FATT_RUN10
        new State(SPR_FATT, 5, 4, A_Chase, S_FATT_RUN12, 0, 0), // S_FATT_RUN11
        new State(SPR_FATT, 5, 4, A_Chase, S_FATT_RUN1, 0, 0), // S_FATT_RUN12
        new State(SPR_FATT, 6, 20, A_FatRaise, S_FATT_ATK2, 0, 0), // S_FATT_ATK1
        new State(SPR_FATT, 32775, 10, A_FatAttack1, S_FATT_ATK3, 0, 0), // S_FATT_ATK2
        new State(SPR_FATT, 8, 5, A_FaceTarget, S_FATT_ATK4, 0, 0), // S_FATT_ATK3
        new State(SPR_FATT, 6, 5, A_FaceTarget, S_FATT_ATK5, 0, 0), // S_FATT_ATK4
        new State(SPR_FATT, 32775, 10, A_FatAttack2, S_FATT_ATK6, 0, 0), // S_FATT_ATK5
        new State(SPR_FATT, 8, 5, A_FaceTarget, S_FATT_ATK7, 0, 0), // S_FATT_ATK6
        new State(SPR_FATT, 6, 5, A_FaceTarget, S_FATT_ATK8, 0, 0), // S_FATT_ATK7
        new State(SPR_FATT, 32775, 10, A_FatAttack3, S_FATT_ATK9, 0, 0), // S_FATT_ATK8
        new State(SPR_FATT, 8, 5, A_FaceTarget, S_FATT_ATK10, 0, 0), // S_FATT_ATK9
        new State(SPR_FATT, 6, 5, A_FaceTarget, S_FATT_RUN1, 0, 0), // S_FATT_ATK10
        new State(SPR_FATT, 9, 3, null, S_FATT_PAIN2, 0, 0), // S_FATT_PAIN
        new State(SPR_FATT, 9, 3, A_Pain, S_FATT_RUN1, 0, 0), // S_FATT_PAIN2
        new State(SPR_FATT, 10, 6, null, S_FATT_DIE2, 0, 0), // S_FATT_DIE1
        new State(SPR_FATT, 11, 6, A_Scream, S_FATT_DIE3, 0, 0), // S_FATT_DIE2
        new State(SPR_FATT, 12, 6, A_Fall, S_FATT_DIE4, 0, 0), // S_FATT_DIE3
        ...
        new State(SPR_FATT, 19, -1, A_BossDeath, S_NULL, 0, 0), // S_FATT_DIE10
        ...
        new State(SPR_CPOS, 0, 10, A_Look, S_CPOS_STND2, 0, 0), // S_CPOS_STND
        new State(SPR_CPOS, 1, 10, A_Look, S_CPOS_STND, 0, 0), // S_CPOS_STND2
        new State(SPR_CPOS, 0, 3, A_Chase, S_CPOS_RUN2, 0, 0), // S_CPOS_RUN1
        new State(SPR_CPOS, 0, 3, A_Chase, S_CPOS_RUN3, 0, 0), // S_CPOS_RUN2
        new State(SPR_CPOS, 1, 3, A_Chase, S_CPOS_RUN4, 0, 0), // S_CPOS_RUN3
        new State(SPR_CPOS, 1, 3, A_Chase, S_CPOS_RUN5, 0, 0), // S_CPOS_RUN4
        new State(SPR_CPOS, 2, 3, A_Chase, S_CPOS_RUN6, 0, 0), // S_CPOS_RUN5
        new State(SPR_CPOS, 2, 3, A_Chase, S_CPOS_RUN7, 0, 0), // S_CPOS_RUN6
        new State(SPR_CPOS, 3, 3, A_Chase, S_CPOS_RUN8, 0, 0), // S_CPOS_RUN7
        new State(SPR_CPOS, 3, 3, A_Chase, S_CPOS_RUN1, 0, 0), // S_CPOS_RUN8
        new State(SPR_CPOS, 4, 10, A_FaceTarget, S_CPOS_ATK2, 0, 0), // S_CPOS_ATK1
        new State(SPR_CPOS, 32773, 4, A_CPosAttack, S_CPOS_ATK3, 0, 0), // S_CPOS_ATK2
        new State(SPR_CPOS, 32772, 4, A_CPosAttack, S_CPOS_ATK4, 0, 0), // S_CPOS_ATK3
        new State(SPR_CPOS, 5, 1, A_CPosRefire, S_CPOS_ATK2, 0, 0), // S_CPOS_ATK4
        new State(SPR_CPOS, 6, 3, null, S_CPOS_PAIN2, 0, 0), // S_CPOS_PAIN
        new State(SPR_CPOS, 6, 3, A_Pain, S_CPOS_RUN1, 0, 0), // S_CPOS_PAIN2
        new State(SPR_CPOS, 7, 5, null, S_CPOS_DIE2, 0, 0), // S_CPOS_DIE1
        new State(SPR_CPOS, 8, 5, A_Scream, S_CPOS_DIE3, 0, 0), // S_CPOS_DIE2
        new State(SPR_CPOS, 9, 5, A_Fall, S_CPOS_DIE4, 0, 0), // S_CPOS_DIE3
        ...
        new State(SPR_CPOS, 15, 5, A_XScream, S_CPOS_XDIE3, 0, 0), // S_CPOS_XDIE2
        new State(SPR_CPOS, 16, 5, A_Fall, S_CPOS_XDIE4, 0, 0), // S_CPOS_XDIE3
        ...
        new State(SPR_TROO, 0, 10, A_Look, S_TROO_STND2, 0, 0), // S_TROO_STND
        new State(SPR_TROO, 1, 10, A_Look, S_TROO_STND, 0, 0), // S_TROO_STND2
        new State(SPR_TROO, 0, 3, A_Chase, S_TROO_RUN2, 0, 0), // S_TROO_RUN1
        new State(SPR_TROO, 0, 3, A_Chase, S_TROO_RUN3, 0, 0), // S_TROO_RUN2
        new State(SPR_TROO, 1, 3, A_Chase, S_TROO_RUN4, 0, 0), // S_TROO_RUN3
        new State(SPR_TROO, 1, 3, A_Chase, S_TROO_RUN5, 0, 0), // S_TROO_RUN4
        new State(SPR_TROO, 2, 3, A_Chase, S_TROO_RUN6, 0, 0), // S_TROO_RUN5
        new State(SPR_TROO, 2, 3, A_Chase, S_TROO_RUN7, 0, 0), // S_TROO_RUN6
        new State(SPR_TROO, 3, 3, A_Chase, S_TROO_RUN8, 0, 0), // S_TROO_RUN7
        new State(SPR_TROO, 3, 3, A_Chase, S_TROO_RUN1, 0, 0), // S_TROO_RUN8
        new State(SPR_TROO, 4, 8, A_FaceTarget, S_TROO_ATK2, 0, 0), // S_TROO_ATK1
        new State(SPR_TROO, 5, 8, A_FaceTarget, S_TROO_ATK3, 0, 0), // S_TROO_ATK2
        new State(SPR_TROO, 6, 6, A_TroopAttack, S_TROO_RUN1, 0, 0), // S_TROO_ATK3
        new State(SPR_TROO, 7, 2, null, S_TROO_PAIN2, 0, 0), // S_TROO_PAIN
        new State(SPR_TROO, 7, 2, A_Pain, S_TROO_RUN1, 0, 0), // S_TROO_PAIN2
        new State(SPR_TROO, 8, 8, null, S_TROO_DIE2, 0, 0), // S_TROO_DIE1
        new State(SPR_TROO, 9, 8, A_Scream, S_TROO_DIE3, 0, 0), // S_TROO_DIE2
        new State(SPR_TROO, 10, 6, null, S_TROO_DIE4, 0, 0), // S_TROO_DIE3
        new State(SPR_TROO, 11, 6, A_Fall, S_TROO_DIE5, 0, 0), // S_TROO_DIE4
        new State(SPR_TROO, 12, -1, null, S_NULL, 0, 0), // S_TROO_DIE5
        new State(SPR_TROO, 13, 5, null, S_TROO_XDIE2, 0, 0), // S_TROO_XDIE1
        new State(SPR_TROO, 14, 5, A_XScream, S_TROO_XDIE3, 0, 0), // S_TROO_XDIE2
        new State(SPR_TROO, 15, 5, null, S_TROO_XDIE4, 0, 0), // S_TROO_XDIE3
        new State(SPR_TROO, 16, 5, A_Fall, S_TROO_XDIE5, 0, 0), // S_TROO_XDIE4
        ...
        new State(SPR_SARG, 0, 10, A_Look, S_SARG_STND2, 0, 0), // S_SARG_STND
        new State(SPR_SARG, 1, 10, A_Look, S_SARG_STND, 0, 0), // S_SARG_STND2
        new State(SPR_SARG, 0, 2, A_Chase, S_SARG_RUN2, 0, 0), // S_SARG_RUN1
        new State(SPR_SARG, 0, 2, A_Chase, S_SARG_RUN3, 0, 0), // S_SARG_RUN2
        new State(SPR_SARG, 1, 2, A_Chase, S_SARG_RUN4, 0, 0), // S_SARG_RUN3
        new State(SPR_SARG, 1, 2, A_Chase, S_SARG_RUN5, 0, 0), // S_SARG_RUN4
        new State(SPR_SARG, 2, 2, A_Chase, S_SARG_RUN6, 0, 0), // S_SARG_RUN5
        new State(SPR_SARG, 2, 2, A_Chase, S_SARG_RUN7, 0, 0), // S_SARG_RUN6
        new State(SPR_SARG, 3, 2, A_Chase, S_SARG_RUN8, 0, 0), // S_SARG_RUN7
        new State(SPR_SARG, 3, 2, A_Chase, S_SARG_RUN1, 0, 0), // S_SARG_RUN8
        new State(SPR_SARG, 4, 8, A_FaceTarget, S_SARG_ATK2, 0, 0), // S_SARG_ATK1
        new State(SPR_SARG, 5, 8, A_FaceTarget, S_SARG_ATK3, 0, 0), // S_SARG_ATK2
        new State(SPR_SARG, 6, 8, A_SargAttack, S_SARG_RUN1, 0, 0), // S_SARG_ATK3
        new State(SPR_SARG, 7, 2, null, S_SARG_PAIN2, 0, 0), // S_SARG_PAIN
        new State(SPR_SARG, 7, 2, A_Pain, S_SARG_RUN1, 0, 0), // S_SARG_PAIN2
        new State(SPR_SARG, 8, 8, null, S_SARG_DIE2, 0, 0), // S_SARG_DIE1
        new State(SPR_SARG, 9, 8, A_Scream, S_SARG_DIE3, 0, 0), // S_SARG_DIE2
        new State(SPR_SARG, 10, 4, null, S_SARG_DIE4, 0, 0), // S_SARG_DIE3
        new State(SPR_SARG, 11, 4, A_Fall, S_SARG_DIE5, 0, 0), // S_SARG_DIE4
        ...
        new State(SPR_HEAD, 0, 10, A_Look, S_HEAD_STND, 0, 0), // S_HEAD_STND
        new State(SPR_HEAD, 0, 3, A_Chase, S_HEAD_RUN1, 0, 0), // S_HEAD_RUN1
        new State(SPR_HEAD, 1, 5, A_FaceTarget, S_HEAD_ATK2, 0, 0), // S_HEAD_ATK1
        new State(SPR_HEAD, 2, 5, A_FaceTarget, S_HEAD_ATK3, 0, 0), // S_HEAD_ATK2
        new State(SPR_HEAD, 32771, 5, A_HeadAttack, S_HEAD_RUN1, 0, 0), // S_HEAD_ATK3
        new State(SPR_HEAD, 4, 3, null, S_HEAD_PAIN2, 0, 0), // S_HEAD_PAIN
        new State(SPR_HEAD, 4, 3, A_Pain, S_HEAD_PAIN3, 0, 0), // S_HEAD_PAIN2
        new State(SPR_HEAD, 5, 6, null, S_HEAD_RUN1, 0, 0), // S_HEAD_PAIN3
        new State(SPR_HEAD, 6, 8, null, S_HEAD_DIE2, 0, 0), // S_HEAD_DIE1
        new State(SPR_HEAD, 7, 8, A_Scream, S_HEAD_DIE3, 0, 0), // S_HEAD_DIE2
        new State(SPR_HEAD, 8, 8, null, S_HEAD_DIE4, 0, 0), // S_HEAD_DIE3
        new State(SPR_HEAD, 9, 8, null, S_HEAD_DIE5, 0, 0), // S_HEAD_DIE4
        new State(SPR_HEAD, 10, 8, A_Fall, S_HEAD_DIE6, 0, 0), // S_HEAD_DIE5
        ...
        new State(SPR_BOSS, 0, 10, A_Look, S_BOSS_STND2, 0, 0), // S_BOSS_STND
        new State(SPR_BOSS, 1, 10, A_Look, S_BOSS_STND, 0, 0), // S_BOSS_STND2
        new State(SPR_BOSS, 0, 3, A_Chase, S_BOSS_RUN2, 0, 0), // S_BOSS_RUN1
        new State(SPR_BOSS, 0, 3, A_Chase, S_BOSS_RUN3, 0, 0), // S_BOSS_RUN2
        new State(SPR_BOSS, 1, 3, A_Chase, S_BOSS_RUN4, 0, 0), // S_BOSS_RUN3
        new State(SPR_BOSS, 1, 3, A_Chase, S_BOSS_RUN5, 0, 0), // S_BOSS_RUN4
        new State(SPR_BOSS, 2, 3, A_Chase, S_BOSS_RUN6, 0, 0), // S_BOSS_RUN5
        new State(SPR_BOSS, 2, 3, A_Chase, S_BOSS_RUN7, 0, 0), // S_BOSS_RUN6
        new State(SPR_BOSS, 3, 3, A_Chase, S_BOSS_RUN8, 0, 0), // S_BOSS_RUN7
        new State(SPR_BOSS, 3, 3, A_Chase, S_BOSS_RUN1, 0, 0), // S_BOSS_RUN8
        new State(SPR_BOSS, 4, 8, A_FaceTarget, S_BOSS_ATK2, 0, 0), // S_BOSS_ATK1
        new State(SPR_BOSS, 5, 8, A_FaceTarget, S_BOSS_ATK3, 0, 0), // S_BOSS_ATK2
        new State(SPR_BOSS, 6, 8, A_BruisAttack, S_BOSS_RUN1, 0, 0), // S_BOSS_ATK3
        new State(SPR_BOSS, 7, 2, null, S_BOSS_PAIN2, 0, 0), // S_BOSS_PAIN
        new State(SPR_BOSS, 7, 2, A_Pain, S_BOSS_RUN1, 0, 0), // S_BOSS_PAIN2
        new State(SPR_BOSS, 8, 8, null, S_BOSS_DIE2, 0, 0), // S_BOSS_DIE1
        new State(SPR_BOSS, 9, 8, A_Scream, S_BOSS_DIE3, 0, 0), // S_BOSS_DIE2
        new State(SPR_BOSS, 10, 8, null, S_BOSS_DIE4, 0, 0), // S_BOSS_DIE3
        new State(SPR_BOSS, 11, 8, A_Fall, S_BOSS_DIE5, 0, 0), // S_BOSS_DIE4
        new State(SPR_BOSS, 12, 8, null, S_BOSS_DIE6, 0, 0), // S_BOSS_DIE5
        new State(SPR_BOSS, 13, 8, null, S_BOSS_DIE7, 0, 0), // S_BOSS_DIE6
        new State(SPR_BOSS, 14, -1, A_BossDeath, S_NULL, 0, 0), // S_BOSS_DIE7
        ...
        new State(SPR_BOS2, 0, 10, A_Look, S_BOS2_STND2, 0, 0), // S_BOS2_STND
        new State(SPR_BOS2, 1, 10, A_Look, S_BOS2_STND, 0, 0), // S_BOS2_STND2
        new State(SPR_BOS2, 0, 3, A_Chase, S_BOS2_RUN2, 0, 0), // S_BOS2_RUN1
        new State(SPR_BOS2, 0, 3, A_Chase, S_BOS2_RUN3, 0, 0), // S_BOS2_RUN2
        new State(SPR_BOS2, 1, 3, A_Chase, S_BOS2_RUN4, 0, 0), // S_BOS2_RUN3
        new State(SPR_BOS2, 1, 3, A_Chase, S_BOS2_RUN5, 0, 0), // S_BOS2_RUN4
        new State(SPR_BOS2, 2, 3, A_Chase, S_BOS2_RUN6, 0, 0), // S_BOS2_RUN5
        new State(SPR_BOS2, 2, 3, A_Chase, S_BOS2_RUN7, 0, 0), // S_BOS2_RUN6
        new State(SPR_BOS2, 3, 3, A_Chase, S_BOS2_RUN8, 0, 0), // S_BOS2_RUN7
        new State(SPR_BOS2, 3, 3, A_Chase, S_BOS2_RUN1, 0, 0), // S_BOS2_RUN8
        new State(SPR_BOS2, 4, 8, A_FaceTarget, S_BOS2_ATK2, 0, 0), // S_BOS2_ATK1
        new State(SPR_BOS2, 5, 8, A_FaceTarget, S_BOS2_ATK3, 0, 0), // S_BOS2_ATK2
        new State(SPR_BOS2, 6, 8, A_BruisAttack, S_BOS2_RUN1, 0, 0), // S_BOS2_ATK3
        new State(SPR_BOS2, 7, 2, null, S_BOS2_PAIN2, 0, 0), // S_BOS2_PAIN
        new State(SPR_BOS2, 7, 2, A_Pain, S_BOS2_RUN1, 0, 0), // S_BOS2_PAIN2
        new State(SPR_BOS2, 8, 8, null, S_BOS2_DIE2, 0, 0), // S_BOS2_DIE1
        new State(SPR_BOS2, 9, 8, A_Scream, S_BOS2_DIE3, 0, 0), // S_BOS2_DIE2
        new State(SPR_BOS2, 10, 8, null, S_BOS2_DIE4, 0, 0), // S_BOS2_DIE3
        new State(SPR_BOS2, 11, 8, A_Fall, S_BOS2_DIE5, 0, 0), // S_BOS2_DIE4
        ...
        new State(SPR_SKUL, 32768, 10, A_Look, S_SKULL_STND2, 0, 0), // S_SKULL_STND
        new State(SPR_SKUL, 32769, 10, A_Look, S_SKULL_STND, 0, 0), // S_SKULL_STND2
        new State(SPR_SKUL, 32768, 6, A_Chase, S_SKULL_RUN2, 0, 0), // S_SKULL_RUN1
        new State(SPR_SKUL, 32769, 6, A_Chase, S_SKULL_RUN1, 0, 0), // S_SKULL_RUN2
        new State(SPR_SKUL, 32770, 10, A_FaceTarget, S_SKULL_ATK2, 0, 0), // S_SKULL_ATK1
        new State(SPR_SKUL, 32771, 4, A_SkullAttack, S_SKULL_ATK3, 0, 0), // S_SKULL_ATK2
        ...
        new State(SPR_SKUL, 32772, 3, A_Pain, S_SKULL_RUN1, 0, 0), // S_SKULL_PAIN2
        new State(SPR_SKUL, 32773, 6, null, S_SKULL_DIE2, 0, 0), // S_SKULL_DIE1
        new State(SPR_SKUL, 32774, 6, A_Scream, S_SKULL_DIE3, 0, 0), // S_SKULL_DIE2
        new State(SPR_SKUL, 32775, 6, null, S_SKULL_DIE4, 0, 0), // S_SKULL_DIE3
        new State(SPR_SKUL, 32776, 6, A_Fall, S_SKULL_DIE5, 0, 0), // S_SKULL_DIE4
        new State(SPR_SKUL, 9, 6, null, S_SKULL_DIE6, 0, 0), // S_SKULL_DIE5
        new State(SPR_SKUL, 10, 6, null, S_NULL, 0, 0), // S_SKULL_DIE6
        new State(SPR_SPID, 0, 10, A_Look, S_SPID_STND2, 0, 0), // S_SPID_STND
        new State(SPR_SPID, 1, 10, A_Look, S_SPID_STND, 0, 0), // S_SPID_STND2
        new State(SPR_SPID, 0, 3, A_Metal, S_SPID_RUN2, 0, 0), // S_SPID_RUN1
        new State(SPR_SPID, 0, 3, A_Chase, S_SPID_RUN3, 0, 0), // S_SPID_RUN2
        new State(SPR_SPID, 1, 3, A_Chase, S_SPID_RUN4, 0, 0), // S_SPID_RUN3
        new State(SPR_SPID, 1, 3, A_Chase, S_SPID_RUN5, 0, 0), // S_SPID_RUN4
        new State(SPR_SPID, 2, 3, A_Metal, S_SPID_RUN6, 0, 0), // S_SPID_RUN5
        new State(SPR_SPID, 2, 3, A_Chase, S_SPID_RUN7, 0, 0), // S_SPID_RUN6
        new State(SPR_SPID, 3, 3, A_Chase, S_SPID_RUN8, 0, 0), // S_SPID_RUN7
        new State(SPR_SPID, 3, 3, A_Chase, S_SPID_RUN9, 0, 0), // S_SPID_RUN8
        new State(SPR_SPID, 4, 3, A_Metal, S_SPID_RUN10, 0, 0), // S_SPID_RUN9
        new State(SPR_SPID, 4, 3, A_Chase, S_SPID_RUN11, 0, 0), // S_SPID_RUN10
        new State(SPR_SPID, 5, 3, A_Chase, S_SPID_RUN12, 0, 0), // S_SPID_RUN11
        new State(SPR_SPID, 5, 3, A_Chase, S_SPID_RUN1, 0, 0), // S_SPID_RUN12
        new State(SPR_SPID, 32768, 20, A_FaceTarget, S_SPID_ATK2, 0, 0), // S_SPID_ATK1
        new State(SPR_SPID, 32774, 4, A_SPosAttack, S_SPID_ATK3, 0, 0), // S_SPID_ATK2
        new State(SPR_SPID, 32775, 4, A_SPosAttack, S_SPID_ATK4, 0, 0), // S_SPID_ATK3
        new State(SPR_SPID, 32775, 1, A_SpidRefire, S_SPID_ATK2, 0, 0), // S_SPID_ATK4
        new State(SPR_SPID, 8, 3, null, S_SPID_PAIN2, 0, 0), // S_SPID_PAIN
        new State(SPR_SPID, 8, 3, A_Pain, S_SPID_RUN1, 0, 0), // S_SPID_PAIN2
        new State(SPR_SPID, 9, 20, A_Scream, S_SPID_DIE2, 0, 0), // S_SPID_DIE1
        new State(SPR_SPID, 10, 10, A_Fall, S_SPID_DIE3, 0, 0), // S_SPID_DIE2
        ...
        new State(SPR_SPID, 18, -1, A_BossDeath, S_NULL, 0, 0), // S_SPID_DIE11
        new State(SPR_BSPI, 0, 10, A_Look, S_BSPI_STND2, 0, 0), // S_BSPI_STND
        new State(SPR_BSPI, 1, 10, A_Look, S_BSPI_STND, 0, 0), // S_BSPI_STND2
        new State(SPR_BSPI, 0, 20, null, S_BSPI_RUN1, 0, 0), // S_BSPI_SIGHT
        new State(SPR_BSPI, 0, 3, A_BabyMetal, S_BSPI_RUN2, 0, 0), // S_BSPI_RUN1
        new State(SPR_BSPI, 0, 3, A_Chase, S_BSPI_RUN3, 0, 0), // S_BSPI_RUN2
        new State(SPR_BSPI, 1, 3, A_Chase, S_BSPI_RUN4, 0, 0), // S_BSPI_RUN3
        new State(SPR_BSPI, 1, 3, A_Chase, S_BSPI_RUN5, 0, 0), // S_BSPI_RUN4
        new State(SPR_BSPI, 2, 3, A_Chase, S_BSPI_RUN6, 0, 0), // S_BSPI_RUN5
        new State(SPR_BSPI, 2, 3, A_Chase, S_BSPI_RUN7, 0, 0), // S_BSPI_RUN6
        new State(SPR_BSPI, 3, 3, A_BabyMetal, S_BSPI_RUN8, 0, 0), // S_BSPI_RUN7
        new State(SPR_BSPI, 3, 3, A_Chase, S_BSPI_RUN9, 0, 0), // S_BSPI_RUN8
        new State(SPR_BSPI, 4, 3, A_Chase, S_BSPI_RUN10, 0, 0), // S_BSPI_RUN9
        new State(SPR_BSPI, 4, 3, A_Chase, S_BSPI_RUN11, 0, 0), // S_BSPI_RUN10
        new State(SPR_BSPI, 5, 3, A_Chase, S_BSPI_RUN12, 0, 0), // S_BSPI_RUN11
        new State(SPR_BSPI, 5, 3, A_Chase, S_BSPI_RUN1, 0, 0), // S_BSPI_RUN12
        new State(SPR_BSPI, 32768, 20, A_FaceTarget, S_BSPI_ATK2, 0, 0), // S_BSPI_ATK1
        new State(SPR_BSPI, 32774, 4, A_BspiAttack, S_BSPI_ATK3, 0, 0), // S_BSPI_ATK2
        new State(SPR_BSPI, 32775, 4, null, S_BSPI_ATK4, 0, 0), // S_BSPI_ATK3
        new State(SPR_BSPI, 32775, 1, A_SpidRefire, S_BSPI_ATK2, 0, 0), // S_BSPI_ATK4
        new State(SPR_BSPI, 8, 3, null, S_BSPI_PAIN2, 0, 0), // S_BSPI_PAIN
        new State(SPR_BSPI, 8, 3, A_Pain, S_BSPI_RUN1, 0, 0), // S_BSPI_PAIN2
        new State(SPR_BSPI, 9, 20, A_Scream, S_BSPI_DIE2, 0, 0), // S_BSPI_DIE1
        new State(SPR_BSPI, 10, 7, A_Fall, S_BSPI_DIE3, 0, 0), // S_BSPI_DIE2
        ...
        new State(SPR_BSPI, 15, -1, A_BossDeath, S_NULL, 0, 0), // S_BSPI_DIE7
        ...
        new State(SPR_CYBR, 0, 10, A_Look, S_CYBER_STND2, 0, 0), // S_CYBER_STND
        new State(SPR_CYBR, 1, 10, A_Look, S_CYBER_STND, 0, 0), // S_CYBER_STND2
        new State(SPR_CYBR, 0, 3, A_Hoof, S_CYBER_RUN2, 0, 0), // S_CYBER_RUN1
        new State(SPR_CYBR, 0, 3, A_Chase, S_CYBER_RUN3, 0, 0), // S_CYBER_RUN2
        new State(SPR_CYBR, 1, 3, A_Chase, S_CYBER_RUN4, 0, 0), // S_CYBER_RUN3
        new State(SPR_CYBR, 1, 3, A_Chase, S_CYBER_RUN5, 0, 0), // S_CYBER_RUN4
        new State(SPR_CYBR, 2, 3, A_Chase, S_CYBER_RUN6, 0, 0), // S_CYBER_RUN5
        new State(SPR_CYBR, 2, 3, A_Chase, S_CYBER_RUN7, 0, 0), // S_CYBER_RUN6
        new State(SPR_CYBR, 3, 3, A_Metal, S_CYBER_RUN8, 0, 0), // S_CYBER_RUN7
        new State(SPR_CYBR, 3, 3, A_Chase, S_CYBER_RUN1, 0, 0), // S_CYBER_RUN8
        new State(SPR_CYBR, 4, 6, A_FaceTarget, S_CYBER_ATK2, 0, 0), // S_CYBER_ATK1
        new State(SPR_CYBR, 5, 12, A_CyberAttack, S_CYBER_ATK3, 0, 0), // S_CYBER_ATK2
        new State(SPR_CYBR, 4, 12, A_FaceTarget, S_CYBER_ATK4, 0, 0), // S_CYBER_ATK3
        new State(SPR_CYBR, 5, 12, A_CyberAttack, S_CYBER_ATK5, 0, 0), // S_CYBER_ATK4
        new State(SPR_CYBR, 4, 12, A_FaceTarget, S_CYBER_ATK6, 0, 0), // S_CYBER_ATK5
        new State(SPR_CYBR, 5, 12, A_CyberAttack, S_CYBER_RUN1, 0, 0), // S_CYBER_ATK6
        new State(SPR_CYBR, 6, 10, A_Pain, S_CYBER_RUN1, 0, 0), // S_CYBER_PAIN
        new State(SPR_CYBR, 7, 10, null, S_CYBER_DIE2, 0, 0), // S_CYBER_DIE1
        new State(SPR_CYBR, 8, 10, A_Scream, S_CYBER_DIE3, 0, 0), // S_CYBER_DIE2
        ...
        new State(SPR_CYBR, 12, 10, A_Fall, S_CYBER_DIE7, 0, 0), // S_CYBER_DIE6
        ...
        new State(SPR_CYBR, 15, -1, A_BossDeath, S_NULL, 0, 0), // S_CYBER_DIE10
        new State(SPR_PAIN, 0, 10, A_Look, S_PAIN_STND, 0, 0), // S_PAIN_STND
        new State(SPR_PAIN, 0, 3, A_Chase, S_PAIN_RUN2, 0, 0), // S_PAIN_RUN1
        new State(SPR_PAIN, 0, 3, A_Chase, S_PAIN_RUN3, 0, 0), // S_PAIN_RUN2
        new State(SPR_PAIN, 1, 3, A_Chase, S_PAIN_RUN4, 0, 0), // S_PAIN_RUN3
        new State(SPR_PAIN, 1, 3, A_Chase, S_PAIN_RUN5, 0, 0), // S_PAIN_RUN4
        new State(SPR_PAIN, 2, 3, A_Chase, S_PAIN_RUN6, 0, 0), // S_PAIN_RUN5
        new State(SPR_PAIN, 2, 3, A_Chase, S_PAIN_RUN1, 0, 0), // S_PAIN_RUN6
        new State(SPR_PAIN, 3, 5, A_FaceTarget, S_PAIN_ATK2, 0, 0), // S_PAIN_ATK1
        new State(SPR_PAIN, 4, 5, A_FaceTarget, S_PAIN_ATK3, 0, 0), // S_PAIN_ATK2
        new State(SPR_PAIN, 32773, 5, A_FaceTarget, S_PAIN_ATK4, 0, 0), // S_PAIN_ATK3
        new State(SPR_PAIN, 32773, 0, A_PainAttack, S_PAIN_RUN1, 0, 0), // S_PAIN_ATK4
        new State(SPR_PAIN, 6, 6, null, S_PAIN_PAIN2, 0, 0), // S_PAIN_PAIN
        new State(SPR_PAIN, 6, 6, A_Pain, S_PAIN_RUN1, 0, 0), // S_PAIN_PAIN2
        new State(SPR_PAIN, 32775, 8, null, S_PAIN_DIE2, 0, 0), // S_PAIN_DIE1
        new State(SPR_PAIN, 32776, 8, A_Scream, S_PAIN_DIE3, 0, 0), // S_PAIN_DIE2
        new State(SPR_PAIN, 32777, 8, null, S_PAIN_DIE4, 0, 0), // S_PAIN_DIE3
        new State(SPR_PAIN, 32778, 8, null, S_PAIN_DIE5, 0, 0), // S_PAIN_DIE4
        new State(SPR_PAIN, 32779, 8, A_PainDie, S_PAIN_DIE6, 0, 0), // S_PAIN_DIE5
        ...
        new State(SPR_SSWV, 0, 10, A_Look, S_SSWV_STND2, 0, 0), // S_SSWV_STND
        new State(SPR_SSWV, 1, 10, A_Look, S_SSWV_STND, 0, 0), // S_SSWV_STND2
        new State(SPR_SSWV, 0, 3, A_Chase, S_SSWV_RUN2, 0, 0), // S_SSWV_RUN1
        new State(SPR_SSWV, 0, 3, A_Chase, S_SSWV_RUN3, 0, 0), // S_SSWV_RUN2
        new State(SPR_SSWV, 1, 3, A_Chase, S_SSWV_RUN4, 0, 0), // S_SSWV_RUN3
        new State(SPR_SSWV, 1, 3, A_Chase, S_SSWV_RUN5, 0, 0), // S_SSWV_RUN4
        new State(SPR_SSWV, 2, 3, A_Chase, S_SSWV_RUN6, 0, 0), // S_SSWV_RUN5
        new State(SPR_SSWV, 2, 3, A_Chase, S_SSWV_RUN7, 0, 0), // S_SSWV_RUN6
        new State(SPR_SSWV, 3, 3, A_Chase, S_SSWV_RUN8, 0, 0), // S_SSWV_RUN7
        new State(SPR_SSWV, 3, 3, A_Chase, S_SSWV_RUN1, 0, 0), // S_SSWV_RUN8
        new State(SPR_SSWV, 4, 10, A_FaceTarget, S_SSWV_ATK2, 0, 0), // S_SSWV_ATK1
        new State(SPR_SSWV, 5, 10, A_FaceTarget, S_SSWV_ATK3, 0, 0), // S_SSWV_ATK2
        new State(SPR_SSWV, 32774, 4, A_CPosAttack, S_SSWV_ATK4, 0, 0), // S_SSWV_ATK3
        new State(SPR_SSWV, 5, 6, A_FaceTarget, S_SSWV_ATK5, 0, 0), // S_SSWV_ATK4
        new State(SPR_SSWV, 32774, 4, A_CPosAttack, S_SSWV_ATK6, 0, 0), // S_SSWV_ATK5
        new State(SPR_SSWV, 5, 1, A_CPosRefire, S_SSWV_ATK2, 0, 0), // S_SSWV_ATK6
        new State(SPR_SSWV, 7, 3, null, S_SSWV_PAIN2, 0, 0), // S_SSWV_PAIN
        new State(SPR_SSWV, 7, 3, A_Pain, S_SSWV_RUN1, 0, 0), // S_SSWV_PAIN2
        new State(SPR_SSWV, 8, 5, null, S_SSWV_DIE2, 0, 0), // S_SSWV_DIE1
        new State(SPR_SSWV, 9, 5, A_Scream, S_SSWV_DIE3, 0, 0), // S_SSWV_DIE2
        new State(SPR_SSWV, 10, 5, A_Fall, S_SSWV_DIE4, 0, 0), // S_SSWV_DIE3
        ...
        new State(SPR_SSWV, 14, 5, A_XScream, S_SSWV_XDIE3, 0, 0), // S_SSWV_XDIE2
        new State(SPR_SSWV, 15, 5, A_Fall, S_SSWV_XDIE4, 0, 0), // S_SSWV_XDIE3
        ...
        new State(SPR_KEEN, 2, 6, A_Scream, S_COMMKEEN4, 0, 0), // S_COMMKEEN3
        ...
        new State(SPR_KEEN, 10, 6, A_KeenDie, S_COMMKEEN12, 0, 0),// S_COMMKEEN11
        new State(SPR_KEEN, 11, -1, null, S_NULL, 0, 0), // S_COMMKEEN12
        new State(SPR_KEEN, 12, 4, null, S_KEENPAIN2, 0, 0), // S_KEENPAIN
        new State(SPR_KEEN, 12, 8, A_Pain, S_KEENSTND, 0, 0), // S_KEENPAIN2
        new State(SPR_BBRN, 0, -1, null, S_NULL, 0, 0), // S_BRAIN
        new State(SPR_BBRN, 1, 36, A_BrainPain, S_BRAIN, 0, 0), // S_BRAIN_PAIN
        new State(SPR_BBRN, 0, 100, A_BrainScream, S_BRAIN_DIE2, 0, 0), // S_BRAIN_DIE1
        new State(SPR_BBRN, 0, 10, null, S_BRAIN_DIE3, 0, 0), // S_BRAIN_DIE2
        new State(SPR_BBRN, 0, 10, null, S_BRAIN_DIE4, 0, 0), // S_BRAIN_DIE3
        new State(SPR_BBRN, 0, -1, A_BrainDie, S_NULL, 0, 0), // S_BRAIN_DIE4
        new State(SPR_SSWV, 0, 10, A_Look, S_BRAINEYE, 0, 0), // S_BRAINEYE
        new State(SPR_SSWV, 0, 181, A_BrainAwake, S_BRAINEYE1, 0, 0), // S_BRAINEYESEE
        new State(SPR_SSWV, 0, 150, A_BrainSpit, S_BRAINEYE1, 0, 0), // S_BRAINEYE1
        new State(SPR_BOSF, 32768, 3, A_SpawnSound, S_SPAWN2, 0, 0), // S_SPAWN1
        new State(SPR_BOSF, 32769, 3, A_SpawnFly, S_SPAWN3, 0, 0), // S_SPAWN2
        new State(SPR_BOSF, 32770, 3, A_SpawnFly, S_SPAWN4, 0, 0), // S_SPAWN3
        new State(SPR_BOSF, 32771, 3, A_SpawnFly, S_SPAWN1, 0, 0), // S_SPAWN4
        new State(SPR_FIRE, 32768, 4, A_Fire, S_SPAWNFIRE2, 0, 0), // S_SPAWNFIRE1
        new State(SPR_FIRE, 32769, 4, A_Fire, S_SPAWNFIRE3, 0, 0), // S_SPAWNFIRE2
        new State(SPR_FIRE, 32770, 4, A_Fire, S_SPAWNFIRE4, 0, 0), // S_SPAWNFIRE3
        new State(SPR_FIRE, 32771, 4, A_Fire, S_SPAWNFIRE5, 0, 0), // S_SPAWNFIRE4
        new State(SPR_FIRE, 32772, 4, A_Fire, S_SPAWNFIRE6, 0, 0), // S_SPAWNFIRE5
        new State(SPR_FIRE, 32773, 4, A_Fire, S_SPAWNFIRE7, 0, 0), // S_SPAWNFIRE6
        new State(SPR_FIRE, 32774, 4, A_Fire, S_SPAWNFIRE8, 0, 0), // S_SPAWNFIRE7
        new State(SPR_FIRE, 32775, 4, A_Fire, S_NULL, 0, 0), // S_SPAWNFIRE8
        ...
        new State(SPR_MISL, 32771, 10, A_BrainExplode, S_NULL, 0, 0), // S_BRAINEXPLODE3
        ...
        new State(SPR_BEXP, 32769, 5, A_Scream, S_BEXP3, 0, 0), // S_BEXP2
        new State(SPR_BEXP, 32770, 5, null, S_BEXP4, 0, 0), // S_BEXP3
        new State(SPR_BEXP, 32771, 10, A_Explode, S_BEXP5, 0, 0), // S_BEXP4
